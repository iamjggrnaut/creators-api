                ...
                html:
                    `<div style="padding: 1rem; background-color: white; margin: 0 auto;">
                            <div style="padding: 1rem; max-width: 560px; margin: 0 auto; ">
                                ...
                                <div style="display: flex; max-width: 560px; text-align: center; margin: 20px auto;">
                ...
                html:
                    `<div style="padding: 1rem; background-color: white; width: 100%; margin: 0 auto; ">
                            <div style="padding: 1rem; max-width: 560px; margin: 0 auto; ">
                                ...
                                <a href="https://radar-analytica.ru/development/confirmation/${email}/${''}" style='border: none; margin: 8px auto; background-color: #5329FF; color: white; border-radius: 8px; padding: 20px 32px; font-weight: 700;text-decoration: none; width: 100%;'>Подтвердить</a>
                                </div>
                                <br />
                                <p>C наилучшими пожеланиями,</p>
                                <p>Команда сервиса Radar Analytica</p>
